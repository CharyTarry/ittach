...
<html>
    ...
    <body>
        ...
        <form action="" align="center">
            ...
            <label for="First name" style="font-size: 20px;">First name</label><br>
            <input type="text" name="fname" required><br>
            <label for="Last name" style="font-size: 20px;">Last name</label><br>
            <input type="text" name="lname" required><br>
            <label for="Course" style="font-size: 20px;">Course(Start with your level)</label><br>
            <input type="text" placeholder="eg Diploma in networking" name="Course" required><br>
            <label for="School" style="font-size: 20px;">School(Your institution)</label><br>
            <input type="text" name="school" required><br>
            <label for="company" style="font-size: 20px;">Company</label><br>
         ...
         <input type="submit" onclick="location.href='vacancies.php';" value="BACK" style="font-size: 20px;font-weight: bold;">
    </body>
</html>  