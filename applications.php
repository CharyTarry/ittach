...
<html>
    ...
    <body>
        ...
        <div class="row">
            <a href="post vacancy.php" class="column" style="text-decoration: none;font-weight: bold;">POST VACANCY</a>
            <a href="My posts.php" class="column" style="text-decoration: none;font-weight: bold;">MY POSTS</a>
            <a href="applications.php" class="column" style="font-weight: bold;">APPLICATIONS</a>
        </div>
    </body>
</html> 